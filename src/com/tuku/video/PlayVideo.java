...
public class PlayVideo extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.tukuduang.R.layout.playvideo);
		
		    ArrayList<String> list=new ArrayList<String>();
		    Intent intent=getIntent();
		    list=intent.getStringArrayListExtra("data");
		    int position=intent.getIntExtra("position", 0);
		    videoUrl=list.get(position);
		
		    System.out.println("videourl:"+videoUrl);
		volumnController = new VolumnController(this);
		mVideo = (FullScreenVideoView) findViewById(com.example.tukuduang.R.id.videoview);
		mPlayTime = (TextView) findViewById(com.example.tukuduang.R.id.play_time);
		mDurationTime = (TextView) findViewById(com.example.tukuduang.R.id.total_time);
		mPlay = (ImageView) findViewById(com.example.tukuduang.R.id.play_btn);
		mSeekBar = (SeekBar) findViewById(com.example.tukuduang.R.id.seekbar);
		mTopView = findViewById(com.example.tukuduang.R.id.top_layout);
		mBottomView = findViewById(com.example.tukuduang.R.id.bottom_layout);
	...
	private void playVideo() {
		...
		mVideo.setOnCompletionListener(new OnCompletionListener() {
			...
			public void onCompletion(MediaPlayer mp) {
				mPlay.setImageResource(com.example.tukuduang.R.drawable.video_btn_down);
				mPlayTime.setText("00:00");
				mSeekBar.setProgress(0);
			}
		});
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case com.example.tukuduang.R.id.play_btn:
			if (mVideo.isPlaying()) {
				mVideo.pause();
				mPlay.setImageResource(com.example.tukuduang.R.drawable.video_btn_down);
			} else {
				mVideo.start();
				mPlay.setImageResource(com.example.tukuduang.R.drawable.video_btn_on);
			}
			break;
		default:
			break;
	...
	private void showOrHide() {
		if (mTopView.getVisibility() == View.VISIBLE) {
			...
			Animation animation = AnimationUtils.loadAnimation(this,
					com.example.tukuduang.R.anim.option_leave_from_top);
			...
			Animation animation1 = AnimationUtils.loadAnimation(this,
					com.example.tukuduang.R.anim.option_leave_from_bottom);
			...
			mTopView.clearAnimation();
			Animation animation = AnimationUtils.loadAnimation(this,
					com.example.tukuduang.R.anim.option_entry_from_top);
			mTopView.startAnimation(animation);

			mBottomView.setVisibility(View.VISIBLE);
			mBottomView.clearAnimation();
			Animation animation1 = AnimationUtils.loadAnimation(this,
					com.example.tukuduang.R.anim.option_entry_from_bottom);
			mBottomView.startAnimation(animation1);
			mHandler.removeCallbacks(hideRunnable);
			mHandler.postDelayed(hideRunnable, HIDE_TIME);
		}
